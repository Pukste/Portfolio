#Asetetaan siemenluku ja otetaan Boston dataset käyttöön
set.seed(500)
library(MASS)
data <- Boston
...
#Splittaa data tehdään lineaarinen regressio ja testataan
...
#otetaan neuralnet kättöön ja tehdään neuralnet train_ datasta
